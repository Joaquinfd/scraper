...
def parse_product(product: dict, scraped_at: str | None = None) -> List[Dict]:
    ...
    row: Dict = {
        ...
        "envase":               _spec_first(product, "Envase"),
        "tipoDeProducto":       _spec_first(product, "Tipo de Producto"),
        "origen":               _spec_first(product, "Origen"),
        "paisDeOrigen":         _spec_first(product, "País de Origen"),
        "idGrupo":              _spec_first(product, "Id Grupo"),
        "idSubrubro":           _spec_first(product, "Id Subrubro"),
...
CSV_FIELDS = [
    ...
    "envase", "tipoDeProducto", "origen", "paisDeOrigen", "idGrupo", "idSubrubro",
